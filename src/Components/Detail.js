        ...
        <div className="Detail Detail-textalign-left">
          <div>
            ...
            <p data-aos="fade-up" className="Detail-content">
              CS DAY คืองานจัดแสดงและประกวดแข่งขันโครงการของนักศึกษาชั้นปีที่ 4 ขึ้นไป ของภาควิชาวิทยาการคอมพิวเตอร์และสารสนเทศ คณะวิทยาศาสตร์ประยุกต์ มหาวิทยาลัยเทคโนโลยีพระจอมเกล้าพระนครเหนือ โดยมีโครงงานของนักศึกษาเป็นจำนวนกว่า 63 โครงงาน จากนักศึกษา 114 คน ทั้งนักศึกษาที่อยู่ในหลักสูตรปกติและสหกิจศึกษา เพื่อแสดงศักยภาพของนักศึกษา และเปิดโอกาสให้นักศึกษารุ่นน้อง ปี 1, 2, และ 3 ได้ค้นหาแรงบรรดาลใจ เก็บเกี่ยวประสบการณ์ ความรู้ และแนวทางในการพัฒนาซอฟต์แวร์ที่มีคุณภาพต่อไป
            </p>
          </div>
          ...
          <div className="Detail-mgtitem">
            ...
            <p data-aos="fade-up" className="Detail-content">
              ในงานนี้ คุณจะได้พบกับโครงการกว่า 63 โครงการที่พร้อมสร้างไอเดียและแรงบันดาลใจให้กับคุณ ทุกโครงการมีการใช้เทคโนโลยีสุดล้ำไม่ว่าจะเป็น
              <br /><span><span className="Detail-technology">►</span>Blockchain Technology</span>
              <br /><span><span className="Detail-technology">►</span>Game</span>
              <br /><span><span className="Detail-technology">►</span>Mobile Application</span>
              <br /><span><span className="Detail-technology">►</span>Network</span>
              <br /><span><span className="Detail-technology">►</span>Tracking</span>
              <br /><span><span className="Detail-technology">►</span>Web Application</span>
